var sliderDiv = document.getElementsByClassName('mainSlider')[0];
...
function Carousel(element) {
	...
	var width;
	var height;
	var images = slider.getElementsByClassName('banner-wrap');
...
carousel.documentInit();var sliderDiv = document.getElementsByClassName('slider')[0];
